...
class INVENTORY1_API UInv_InventoryComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:	
	...
	UFUNCTION(Server,Reliable)
	void Server_DropItem_Implementation(UInv_InventoryItem* Item,int32 StackCount);
