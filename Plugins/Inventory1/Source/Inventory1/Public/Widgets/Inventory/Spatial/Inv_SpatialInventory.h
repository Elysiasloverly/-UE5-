...
UCLASS()
class INVENTORY1_API UInv_SpatialInventory : public UInv_InventoryBase
{
	GENERATED_BODY()
public:
...
private:
	...
	void SetItemDescriptionSizeAndPosition(UInv_ItemDescription* Description,UCanvasPanel* Canvas) ;
	...
	void ClearSoltOfItem(UInv_EquippedGridSlot* EquippedGridSlot);
