...
USTRUCT(BlueprintType)
struct FInv_LabeledNumFragment : public FInv_InventoryItemFragment
{
	GENERATED_BODY()
...
struct FInv_ConsumeModifier: public FInv_LabeledNumFragment
{
	GENERATED_BODY();
...
USTRUCT(BlueprintType)
struct FInv_EquipModifier : public FInv_LabeledNumFragment
{
	GENERATED_BODY()
