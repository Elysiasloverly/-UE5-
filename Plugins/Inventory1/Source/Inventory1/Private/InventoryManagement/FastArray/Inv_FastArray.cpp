...
TArray<UInv_InventoryItem*> FInv_InventoryFastArray::GetAllItem() const
{
...
UInv_InventoryItem* FInv_InventoryFastArray::FindFristItemByType(const FGameplayTag& ItemType)
{
