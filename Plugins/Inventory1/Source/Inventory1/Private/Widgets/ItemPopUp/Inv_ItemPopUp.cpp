...
void UInv_ItemPopUp::NativeOnInitialized()
{
	...
	Button_Split->OnClicked.AddDynamic(this,&ThisClass::UInv_ItemPopUp::SplitButtonClicked);
	Button_Drop->OnClicked.AddDynamic(this,&ThisClass::UInv_ItemPopUp::DropButtonClicked);
	Button_Consume->OnClicked.AddDynamic(this,&ThisClass::UInv_ItemPopUp::ConsumeButtonClicked);
